...
export const TextIcon: React.FC<{className?: string}> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={`w-5 h-5 ${className}`}>
    <path d="M5 4h14v2H5V4zm0 4h14v2H5V8zm0 4h14v2H5v-2zm0 4h8v2H5v-2z" />
  </svg>
);
...
export const ButtonIcon: React.FC<{className?: string}> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={`w-5 h-5 ${className}`}>
    <path d="M5 11h14v2H5v-2zm-2 4h18v2H3v-2zm0-8h18v2H3V7z" />
    <rect x="3" y="9" width="18" height="6" rx="2" ry="2" stroke="currentColor" fill="transparent" strokeWidth="1.5" />
  </svg>
);
...
export const CarouselIcon: React.FC<{className?: string}> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={`w-5 h-5 ${className}`}>
    <path d="M2 7h2v10H2V7zm3 0h2v10H5V7zm14 0h2v10h-2V7zm-3 0h2v10h-2V7zM9 5h6v14H9V5z" />
  </svg>
);
...
export const FooterIcon: React.FC<{className?: string}> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={`w-5 h-5 ${className}`}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M20.25 15.75A2.25 2.25 0 0118 18H6a2.25 2.25 0 01-2.25-2.25V15.75m16.5 0A2.25 2.25 0 0018 13.5H6a2.25 2.25 0 00-2.25 2.25m16.5 0V6.75A2.25 2.25 0 0018 4.5H6A2.25 2.25 0 003.75 6.75v9M20.25 7.5H3.75" />
  </svg>
);